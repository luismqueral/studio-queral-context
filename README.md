...
- Apply color tokens from css/tokens/tpl-color-tokens-light.css for light theme
- Reference typography tokens from css/tokens/tpl-typography.css for consistent spacing
- Include NYT logo from images/logos/New_York_Times_T_icon.svg
- Use Tachyons utility classes from css/nyt-tachyons/ for responsive layout
...
- Color scheme: Light theme tokens (css/tokens/tpl-color-tokens-light.css)
- Typography scale: Reference css/tokens/tpl-typography.css for consistent sizing
- Spacing: Use size tokens from css/tokens/tpl-size-tokens.css
...
- NYT T logo (images/logos/New_York_Times_T_icon.svg) positioned according to brand guidelines
- Dark theme color tokens from css/tokens/tpl-color-tokens-dark.css
- Size tokens from css/tokens/tpl-size-tokens.css for consistent spacing
- Semantic colors from css/tokens/ink_semantic-colors-inverse-(dark).css
...
- Apply semantic color tokens for states (css/tokens/ink_semantic-colors-default-(light).css)
- Reference size tokens for consistent spacing and sizing (css/tokens/tpl-size-tokens.css)
...
- Color palette: Use light theme tokens (css/tokens/tpl-color-tokens-light.css)
...
### Creative Strategy Cards

For creative thinking approaches, see [Strategy Cards](prompts/strategies.md) - 186 prompts designed to help you approach design challenges from unexpected angles.
